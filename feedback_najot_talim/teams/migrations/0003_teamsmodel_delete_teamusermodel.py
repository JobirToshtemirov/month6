...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('teams', '0002_teamusermodel_description_en_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name_ru', models.CharField(max_length=50, null=True, verbose_name='First Name')),
                ...
                ('last_name_ru', models.CharField(max_length=50, null=True, verbose_name='Last Name')),
                ('image', models.ImageField(upload_to='teams/images/', verbose_name='Image')),
